...
**Source**: `.cortex/synapse/prompts/*.md`. MCP client commands map via `user-cortex/<slug>`.
...
- **Command name mapping**: MCP client command `user-cortex/fix_quality` uses snake_case; prompt file is `fix-quality.md`. Document mapping explicitly.
