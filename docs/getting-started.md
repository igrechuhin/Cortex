...
This guide covers MCP client configuration and the quick-start workflow below. For installation, prerequisites, and pre-commit hook setup, see the [README](../README.md#how-to-use-it).
