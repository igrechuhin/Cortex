...
All known call sites include `(ref: cleanup-skipped-legacy-tests)` in the reason string. Files include integration prompt-alignment tests, `test_rules_operations.py`, `test_cursor_agent_sync.py`, `test_python_adapter.py`, `test_check_async_tests_script.py`, `test_pre_commit_tools.py`, `test_implement_select_explicit_plan_prompt.py`, and related integration modules.
