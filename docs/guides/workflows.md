...
- If **plan(operation="complete")** is unavailable, use **roadmap(operation="remove_entry")**, **append_progress_entry**, **append_active_context_entry**, then run the plan-archiver steps manually.
