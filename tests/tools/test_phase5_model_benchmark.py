...
from cortex.tools.phase5_model_benchmark import (
...
async def test_benchmark_model_stores_and_returns_payload(tmp_path: Path) -> None:
    ...
    with (
        patch(
            "cortex.tools.phase5_model_benchmark.resolve_project_root_async",
            new_callable=AsyncMock,
            return_value=tmp_path,
        ),
        patch(
            "cortex.tools.phase5_model_benchmark._run_full_eval",
            new_callable=AsyncMock,
