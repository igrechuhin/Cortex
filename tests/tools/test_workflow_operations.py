"""Tests for workflow operations (agent_workflow suggest_workflow)."""
...
async def test_suggest_workflow_returns_valid_json() -> None:
    """agent_workflow suggest_workflow returns JSON with status, task_description, count, workflows."""
...
async def test_suggest_workflow_recommends_feature_workflow() -> None:
    """agent_workflow suggest_workflow recommends new_feature_development for implement tasks."""
    result = await agent_workflow(
        operation="suggest_workflow",
...
async def test_suggest_workflow_recommends_bug_workflow() -> None:
    """agent_workflow suggest_workflow recommends bug_investigation for debug/fix tasks."""
    result = await agent_workflow(
        operation="suggest_workflow",
...
async def test_suggest_workflow_limit_clamped() -> None:
    """agent_workflow suggest_workflow clamps limit to 1-10."""
    result = await agent_workflow(
        operation="suggest_workflow",
...
def test_agent_workflow_is_deferred_medium() -> None:
    """agent_workflow is catalogued as deferred_medium."""
    assert get_tool_category("agent_workflow") == ToolCategory.DEFERRED_MEDIUM
