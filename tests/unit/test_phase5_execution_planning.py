"""Unit tests for phase5_execution_planning module."""
...
class TestExecuteWithErrorHandling:
    ...
    async def test_returns_error_response_when_inner_raises(self) -> None:
        ...
        with patch(
            "cortex.tools.phase5_execution_planning.execute_validated_refactoring",
...
class TestProvideFeedbackImpl:
    ...
    async def test_returns_error_json_when_suggestion_not_found(self) -> None:
        ...
        with (
            ...
            patch(
                "cortex.tools.phase5_execution_planning.get_managers",
                new_callable=AsyncMock,
                return_value=mgrs,
            ),
            patch(
                "cortex.tools.phase5_execution_planning.extract_feedback_managers",
                new_callable=AsyncMock,
