...
Defines project structure layout, housekeeping, and rules (e.g. shared rules submodule). Optional; created by `setup_project_structure` and defaults used if missing.
