...
git clone https://github.com/your-org/memory-bank-rules.git .cortex/rules-shared
...
{{include:../.cortex/rules-shared/patterns/microservices.md}}
{{include:../.cortex/rules-shared/patterns/api-design.md}}
...
**Create validation schema (.cortex/rules-schema.json):**
...
if __name__ == "__main__":
    ...
    generate_rules(patterns, ".cortex/rules")
```
...
```python
# .cortex/validators/custom_validator.py
    ...
    "custom_validators": [
      {
        ...
        "module": ".cortex.validators.custom_validator",
        "class": "CustomValidator",
