...
`.cortex/synapse/claude-agents/implement-code.md` is the source of truth and syncs to `.claude/agents/implement-code.md`; it points at `docs/guides/synapse-final-report-templates.md`.
