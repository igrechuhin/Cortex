...
- [Phase 54: Clarify MCP Tool Error Handling Classification](../plans/phase-54-clarify-mcp-tool-error-handling.md) - PLANNING (2026-01-26) - Clarify MCP tool error handling rules to distinguish between critical blocking errors and non-critical errors where workarounds exist - Add error classification (critical vs. non-critical), provide alternative approach guidance, and optionally enhance load_context error handling - Addresses ambiguity identified in Phase 28 session optimization review where load_context validation error was handled correctly but rules were unclear - Impact: Prevents ~10-20% of unnecessary investigation plans for non-critical validation errors while maintaining safety for critical issues - Target completion: 2026-02-05
