...
- **Phase 43: Reconsider tools registration** - IN PROGRESS (Step 3 partial 2026-02-02) - Step 3.1 done: mcp_resource_wrapper, handler_kind in usage_models/UsageTracker, usage recording with kind=resource, verification test test_every_mcp_resource_has_required_wrappers. Pilot resources: get_memory_bank_stats_resource (cortex://memory-bank/stats), get_structure_info_resource (cortex://structure/info); tools kept for backward compatibility. Next: Step 3.2 migrate remaining read-only tools to resources. Design: .cortex/plans/phase-43-resource-api-design.md. Audit: .cortex/plans/phase-43-tool-audit.md. Plan: .cortex/plans/phase-43-reconsider-tools-registration.md.
