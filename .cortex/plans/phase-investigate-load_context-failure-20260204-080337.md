# Phase: Investigate load_context MCP Tool Failure
...
**Problem**: The `load_context` MCP tool failed during step: **MCP tool execution**

**Error Details**:

- **Error Type**: `TypeError`
- **Error Message**: `load_context() got an unexpected keyword argument 'project_root'`
...
Auto-generated on MCP tool failure. Tool: load_context, Error:
TypeError: load_context() got an unexpected keyword argument 'project_root'
