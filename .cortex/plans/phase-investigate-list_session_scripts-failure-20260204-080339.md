# Phase: Investigate list_session_scripts MCP Tool Failure
...
**Problem**: The `list_session_scripts` MCP tool failed during step: **MCP tool execution**

**Error Details**:

- **Error Type**: `TypeError`
- **Error Message**: `list_session_scripts() got an unexpected keyword argument 'project_root'`
...
Auto-generated on MCP tool failure. Tool: list_session_scripts, Error:
TypeError: list_session_scripts() got an unexpected keyword argument 'project_root'
