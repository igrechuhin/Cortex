...
- **Error Message**: `module 'cortex.tools.execution.pre_commit_zero_arg_tools' has no attribute 'phase_a_lock'`
...
AttributeError: module 'cortex.tools.execution.pre_commit_zero_arg_tools' has no attribute 'phase_a_lock'
