# Phase: Investigate rules MCP Tool Failure
...
**Problem**: The `rules` MCP tool failed during step: **MCP tool execution**

**Error Details**:

- **Error Type**: `TypeError`
- **Error Message**: `rules() got an unexpected keyword argument 'project_root'`
...
Auto-generated on MCP tool failure. Tool: rules, Error:
TypeError: rules() got an unexpected keyword argument 'project_root'
