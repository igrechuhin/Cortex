# Phase: Investigate validate MCP Tool Failure
...
**Problem**: The `validate` MCP tool failed during step: **MCP tool execution**

**Error Details**:

- **Error Type**: `TypeError`
- **Error Message**: `validate() got an unexpected keyword argument 'project_root'`
...
Auto-generated on MCP tool failure. Tool: validate, Error:
TypeError: validate() got an unexpected keyword argument 'project_root'
