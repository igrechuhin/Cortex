# Phase: Investigate get_version_history MCP Tool Failure
...
**Problem**: The `get_version_history` MCP tool failed during step: **MCP tool execution**

**Error Details**:

- **Error Type**: `TypeError`
- **Error Message**: `get_version_history() got an unexpected keyword argument 'project_root'`
...
Auto-generated on MCP tool failure. Tool: get_version_history, Error:
TypeError: get_version_history() got an unexpected keyword argument 'project_root'
