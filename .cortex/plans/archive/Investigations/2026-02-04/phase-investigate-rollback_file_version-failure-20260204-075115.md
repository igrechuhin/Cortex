# Phase: Investigate rollback_file_version MCP Tool Failure
...
**Problem**: The `rollback_file_version` MCP tool failed during step: **MCP tool execution**

**Error Details**:

- **Error Type**: `TypeError`
- **Error Message**: `rollback_file_version() got an unexpected keyword argument 'project_root'`
...
Auto-generated on MCP tool failure. Tool: rollback_file_version, Error:
TypeError: rollback_file_version() got an unexpected keyword argument 'project_root'
