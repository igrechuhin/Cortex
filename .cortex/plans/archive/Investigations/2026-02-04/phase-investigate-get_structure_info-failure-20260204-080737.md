# Phase: Investigate get_structure_info MCP Tool Failure
...
**Problem**: The `get_structure_info` MCP tool failed during step: **MCP tool execution**

**Error Details**:

- **Error Type**: `TypeError`
- **Error Message**: `get_structure_info() got an unexpected keyword argument 'project_root'`
...
Auto-generated on MCP tool failure. Tool: get_structure_info, Error:
TypeError: get_structure_info() got an unexpected keyword argument 'project_root'
