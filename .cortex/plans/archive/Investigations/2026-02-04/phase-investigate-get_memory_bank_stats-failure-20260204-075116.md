# Phase: Investigate get_memory_bank_stats MCP Tool Failure
...
**Problem**: The `get_memory_bank_stats` MCP tool failed during step: **MCP tool execution**

**Error Details**:

- **Error Type**: `TypeError`
- **Error Message**: `get_memory_bank_stats() got an unexpected keyword argument 'project_root'`
...
Auto-generated on MCP tool failure. Tool: get_memory_bank_stats, Error:
TypeError: get_memory_bank_stats() got an unexpected keyword argument 'project_root'
