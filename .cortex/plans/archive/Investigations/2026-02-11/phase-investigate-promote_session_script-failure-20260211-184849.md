...
- **Error Message**: `Invalid format specifier ' "success", "message": '
        '"Template for promoted session script; implement tool logic."' for object of type 'str'`
...
ValueError: Invalid format specifier ' "success", "message": '
        '"Template for promoted session script; implement tool logic."' for object of type 'str'
