...
**Status**: IN PROGRESS (Session 21 done)
**Priority**: LOW
**Created**: 2026-02-28
...
3. **Move files by domain** (one domain per session):
   ...
   - Session 21: `context/` — moved metadata_helpers, metadata_logging_helpers, hybrid_metadata_helpers; `session/` — moved script_capture_tools, script_capture_handlers, script_capture_helpers, sequential_thinking. Flat files: 14→7. 4867 tests, 92.32% coverage.
