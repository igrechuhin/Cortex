# Phase: Investigate get_dependency_graph MCP Tool Failure
...
**Problem**: The `get_dependency_graph` MCP tool failed during step: **MCP tool execution**

**Error Details**:

- **Error Type**: `TypeError`
- **Error Message**: `get_dependency_graph() got an unexpected keyword argument 'project_root'`
...
Auto-generated on MCP tool failure. Tool: get_dependency_graph, Error:
TypeError: get_dependency_graph() got an unexpected keyword argument 'project_root'
