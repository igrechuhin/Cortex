# Phase: Investigate get_context_usage_statistics MCP Tool Failure
...
**Problem**: The `get_context_usage_statistics` MCP tool failed during step: **MCP tool execution**

**Error Details**:

- **Error Type**: `TypeError`
- **Error Message**: `get_context_usage_statistics() got an unexpected keyword argument 'project_root'`
...
Auto-generated on MCP tool failure. Tool: get_context_usage_statistics, Error:
TypeError: get_context_usage_statistics() got an unexpected keyword argument 'project_root'
