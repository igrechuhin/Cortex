...
- **Error Message**: `execute_pre_commit_checks() got an unexpected keyword argument 'project_root'`
...
TypeError: execute_pre_commit_checks() got an unexpected keyword argument 'project_root'
