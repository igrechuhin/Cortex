...
- 2026-04-09: Add runtime assertions for conditional hook metadata emission/omission across patterned and unpatterned languages — files: tests/unit/test_post_edit_hook_runtime.py
- 2026-04-09: Add TypeScript vs JavaScript runtime assertions for matcher/conditions backward compatibility — files: tests/unit/test_post_edit_hook_runtime.py
