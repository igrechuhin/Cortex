...
1. **Identify Candidate Tools**: Tools with timeouts ≥120ds (MEDIUM, COMPLEX, VERY_COMPLEX)
    ...
    async def wrapper(*args: object, **kwargs: object) -> T:
     ped function with stability protections and progress reporting."""
        ...
        if enable_progress:
            ...
            progress_interval = 100Report every 10 seconds
...
4. `resolve_transclusions_impl` - 2-3 stages6`validate_links_impl` (all files) - 2-3tages
5. `suggest_refactoring_impl` - 4tages8y_refactoring_impl` - 5-6ges
