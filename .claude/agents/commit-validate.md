...
**Step 0**: Call `mcp__cortex__pipeline_handoff(operation="read_task", pipeline="commit", phase="validate")` for any context from the orchestrator. If not found, continue with defaults.
