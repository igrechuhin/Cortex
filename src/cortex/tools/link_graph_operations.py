...
from cortex.tools.link_graph_formatters import (
...
async def get_link_graph(
    ...
    try:
        ...
        if format == "mermaid":
            return generate_mermaid_response(link_graph, cycles)
        return generate_json_response(link_graph, cycles, include_transclusions)
