...
async def _session_handle_start(
    ...
    from cortex.tools.session_start_tools import session_start as _session_start
...
async def _session_handle_register(
    ...
    from cortex.tools.session_registry import session_register as _session_register
...
async def _session_handle_deregister(ctx: MCPContext | None) -> str:
    ...
    from cortex.tools.session_registry import session_deregister as _session_deregister
